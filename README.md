...
> A free-to-use Slack Bot packed with mini-games
...
`Used Gemini 3.1 Pro (High) in Antigravity to fix errors and bugs in the code which I couldn't figure out how to solve. AI was primarily used to debug /slair-unscramble and /slair-guessthenumber commands as I couldn't figure out how to open modals upon clicking a button.`
